...
* * directory_in - папка, где будет производиться поиск файлов дял перевода.
...
2. 700 (700 больше, чем ограничение в 500, первый параграф в части должен быть обязательно)
...
Но при установке лимита в 1500 - 2000 или более, этот эффект будет снижен.
...
Это нужно для более удобной работы с плагинами, например языки дял перевода по умолчанию чаще всего англо-русский,
